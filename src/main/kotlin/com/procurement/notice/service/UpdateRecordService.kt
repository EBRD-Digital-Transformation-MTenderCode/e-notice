...
class UpdateRecordService(
    ...
    fun updateRecord(params: UpdateRecordParams): ProceduralResult<Fail> {

        val data = params.data

        val ocid = parseOcid(data.ocid)
            .doReturn { error -> return ProceduralResult.error(error) }
        ...
        val recordEntity = releaseService.tryGetRecordEntity(cpid, ocid)
            ...
            .get
            ?: return ProceduralResult.error(Fail.Incident.Database.NotFound("Record not found."))
        ...
        val updatedRelease = record.updateRelease(releaseId = releaseId, params = params)
            .doReturn { e -> return ProceduralResult.error(e) }
            .also {
