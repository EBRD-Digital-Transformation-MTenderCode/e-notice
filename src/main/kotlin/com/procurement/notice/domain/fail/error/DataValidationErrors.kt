...
sealed class DataValidationErrors(
    number: String,
    ...
    class DataTypeMismatch(name: String, expectedType: String, actualType: String) : DataValidationErrors(
        number = "2",
        description = "Data type mismatch of attribute '$name'. Expected data type: '$expectedType', actual data type: '$actualType'.",
        name = name
    )

    class UnknownValue(name: String, expectedValues: Collection<String>, actualValue: String) : DataValidationErrors(
        number = "3",
    ...
    class DataFormatMismatch(name: String, expectedFormat: String, actualValue: String) : DataValidationErrors(
        number = "4",
        description = "Data format mismatch of attribute '$name'. Expected data format: '$expectedFormat', actual value: '$actualValue'.",
        name = name
    )

    class DataMismatchToPattern(name: String, pattern: String, actualValue: String) : DataValidationErrors(
        number = "5",
    ...
    class InvalidStringLength(name: String, min: Int? = null, max: Int? = null, actualLength: Int) : DataValidationErrors(
        number = "8",
