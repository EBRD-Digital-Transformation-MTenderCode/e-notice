...
sealed class DataErrors(number: String, override val description: String) :
    Fail.Error(prefix = "DR-", number = number) {

    class Parsing(description: String = "Invalid json") : DataErrors(number = "0", description = description) {
