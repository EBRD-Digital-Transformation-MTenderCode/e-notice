...
fun JsonNode.tryGetAttribute(name: String): Result<JsonNode, DataErrors.Validation> = this.getOrNull(name)
    ?.asSuccess()
    ?: DataErrors.Validation.MissingRequiredAttribute(name = name).asFailure()
